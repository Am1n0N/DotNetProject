...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27D29DBDD7");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4AF270BA2");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85F58FE4A3");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229BFA4EE45");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D46438E56B");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF56380C638");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C423961CE");

            entity.ToTable("staffs");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616416041DD5").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3CD3D108D");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CF6F11C08");
